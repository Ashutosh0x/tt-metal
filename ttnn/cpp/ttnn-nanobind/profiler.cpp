...
void ProfilerModule(nb::module_& mod) {
    ...
    mod.def(
        "get_latest_programs_device_kernel_duration_summary",
        []() {
            return convert_kernel_duration_summaries_to_dict(
                tt::tt_metal::experimental::GetLatestProgramsDeviceKernelDurationSummary());
        },
        R"doc(
    ...
    mod.def(
        "get_all_programs_device_kernel_duration_summary",
        []() {
            return convert_kernel_duration_summaries_to_dict(
                tt::tt_metal::experimental::GetAllProgramsDeviceKernelDurationSummary());
        },
        R"doc(
